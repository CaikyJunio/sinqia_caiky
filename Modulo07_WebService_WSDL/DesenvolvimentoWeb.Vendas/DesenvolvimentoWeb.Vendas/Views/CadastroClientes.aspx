    ...
    <div class="row container">
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="documentoRequiredFieldValidator" 
                    runat="server" 
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="telefoneRequiredFieldValidator" 
                    runat="server" 
                    CssClass ="text-danger"
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="emailRequiredFieldValidator" 
                    ...
                    ErrorMessage="O e-mail deve ser informado" 
               ...
               <asp:RegularExpressionValidator
                   ...
                   runat="server"
                   CssClass ="text-danger"
                   ErrorMessage="Email inválido" ControlToValidate="emailTextBox" 
