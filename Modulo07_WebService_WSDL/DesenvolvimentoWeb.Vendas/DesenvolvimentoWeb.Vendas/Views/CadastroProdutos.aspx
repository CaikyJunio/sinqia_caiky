        ...
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="precoTextBox" placeholder="R$0,00" CssClass="form-control" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="precoRequiredFieldValidator" 
                    runat="server" 
                    CssClass ="text-danger"
                ...
                <div class="form-group">
                    <asp:Button ID="enviarButton" CssClass="btn btn-primary" runat="server" Text="Incluir Produto" OnClick="enviarButton_Click" />
                </div>
