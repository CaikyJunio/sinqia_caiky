        ...
        <asp:Repeater ID="itensRepeater" runat="server">
            ...
            <ItemTemplate>
                <div> 
                    ...
                    <asp:Label ID="produtoLabel" runat="server" 
                        Text='<%# Eval("DescricaoProduto") %>'></asp:Label><br />

                </div>

                <div> 
                    <strong> Numero Pedido: </strong>
                    <asp:Label ID="pedidoLabel" runat="server" 
                ...
                <div> 
                    ...
                    <asp:Label ID="valorLabel" runat="server" 
